...
@section('main')
    <section>
        ...
        <div class="flex justify-between">
            <h1 class="py-1 font-semibold text-3xl text-gray-600 uppercase">edit progress</h1>
        </div>
        @if ($progress)
                ...
                <div class=" gap-4 mt-3">
                    <div class="">
                        <div class="bg-white shadow-lg rounded p-4">
                            <div class="mb-4">
                                <input type="hidden" name="id" value="{{ $progress->id }}" id="id">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="input-border rounded px-2 py-1 w-full" style="margin-top: 10px;z-index: -1" name="description"
                                    id="editor" cols="30" rows="5">{{ $progress->description }}</textarea>
                                @error('description')
                                    <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
